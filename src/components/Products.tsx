...
import rccPipesImage from '@/assets/rcc-pipes.jpg';
import boxCulvertsImage from '@/assets/box-culverts.jpg';
...
const Products = () => {
  ...
  return (
    <section id="products" className="py-20 bg-muted-light/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {products.map((product, index) => (
            <div key={index} className="card-industrial group animate-fade-in-up" style={{animationDelay: `${index * 0.2}s`}}>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {product.applications.map((app, idx) => (
                      <span key={idx} className="px-3 py-1 bg-secondary/20 text-secondary-foreground text-sm rounded-full">
                        {app}
                      </span>
                    ))}
                  </div>
